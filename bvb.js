...
function BVB() {
    ...
    addMatch(Helpers.day(2012, 12, 8), 'VfL Wolfsburg', 2, 3, {
        Blaszczykowski : { goals : 1 },
        Reus : { goals : 1, yellow : 1 },
        Schmelzer : { red : 1 },
        Gündogan : { yellow : 1 },
        Götze : { yellow : 1 }
        },
        [ 'Weidenfeller', 'Piszczek', 'Santana', 'Hummels', 'Gündogan', 'Blaszczykowski', 'Leitner', 'Schmelzer', 'Lewandowski', 'Reus', 'Götze'], [ 'Perisic', 'Schieber' ],
        true);

    addMatch(Helpers.day(2012, 12, 16), '1899 Hoffenheim', 3, 1, {
        Reus : { assists : 1 },
        Leitner : { assists : 1 },
        Grosskreutz : { goals : 1 },
        Götze : { goals : 1, boni : [ Bonus.TOTD ] },
        ...
        [ 'Weidenfeller', 'Piszczek', 'Subotic', 'Hummels', 'Gündogan', 'Blaszczykowski', 'Leitner', 'Grosskreutz', 'Lewandowski', 'Reus', 'Götze'], [ 'Perisic', 'Kirch' /*, 'Hofmann' */ ]);

    addMatch(Helpers.day(2012, 12, 19), 'Hannover 96', 5, 1, {
        Blaszczykowski : { goals : 1 },
        Grosskreutz : { assists : 1 },
        Reus : { assists : 1 },
        Lewandowski : { goals : 1, assists : 1 },
        Bittencourt : { assists : 1 },
        Götze : { goals : 3 }
        },
        [ 'Weidenfeller', 'Piszczek', 'Subotic', 'Hummels', 'Gündogan', 'Blaszczykowski', 'Kehl', 'Grosskreutz', 'Lewandowski', 'Reus', 'Götze'], [ 'Perisic', 'Schieber', 'Bittencourt' ],
        true, 'Pokal');

    addMatch(Helpers.day(2013, 1, 19), 'Werder Bremen', 5, 0, {
        Blaszczykowski : { goals : 1 },
        Grosskreutz : { assists : 1 },
        Reus : { assists : 1, goals : 1 },
        Lewandowski : { goals : 1 },
        Santana : { goals : 1 },
    ...
    addMatch(Helpers.day(2013, 2, 3), 'Bayer Leverkusen', 3, 2, {
        Blaszczykowski : { goals : 1 },
        Reus : { goals : 1 },
        Lewandowski : { goals : 1, assists : 2 },
        Götze : { assists : 1 }
        },
        [ 'Langerak', 'Piszczek', 'Santana', 'Hummels', 'Gündogan', 'Schmelzer', 'Bender', 'Blaszczykowski', 'Lewandowski', 'Reus', 'Götze'], [ 'Grosskreutz', 'Kehl', 'Schieber' ]);

    addMatch(Helpers.day(2013, 2, 9), 'Hamburger SV', 1, 4, {
        Lewandowski : { goals : 1, red : 1 },
        Hummels : { assists : 1 },
        Götze : { yellow : 1 }
        },
        [ 'Weidenfeller', 'Piszczek', 'Santana', 'Hummels', 'Kehl', /* Sahin, */ 'Bender', 'Blaszczykowski', 'Lewandowski', 'Reus', 'Götze'], [ 'Gündogan', 'Schieber' ], true);

    addMatch(Helpers.day(2013, 2, 13), 'Schachtar Donezk', 2, 2, {
        Lewandowski : { goals : 1 },
        Hummels : { goals : 1 },
        Götze : { assists : 1 },
        Schmelzer : { assists : 1 }
        },
        [ 'Weidenfeller', 'Piszczek', 'Santana', 'Hummels', 'Kehl', 'Schmelzer', 'Bender', 'Blaszczykowski', 'Lewandowski', 'Reus', 'Götze'], [ 'Leitner', 'Schieber' ], false, 'CL16');

    addMatch(Helpers.day(2013, 2, 16), 'Eintracht Frankfurt', 3, 0, {
        Reus : { goals : 3 },
        Hummels : { assists : 1 },
        Götze : { assists : 2 },
        Schieber : { yellow : 2 },
        ...
        [ 'Weidenfeller', 'Piszczek', 'Subotic', 'Hummels', 'Gündogan', 'Schmelzer', 'Bender', 'Blaszczykowski', 'Schieber', 'Reus', 'Götze'], [ 'Grosskreutz', 'Leitner' /*, 'Sahin' */ ], true);

    addMatch(Helpers.day(2013, 2, 24), 'Borussia Mönchengladbach', 1, 1, {
        Götze : { goals : 1, assists : 1 },
        Santana : { yellow : 1 }
        },
        [ 'Weidenfeller', 'Piszczek', 'Subotic', 'Hummels', 'Gündogan', 'Schmelzer', 'Kehl', 'Grosskreutz', 'Leitner', 'Reus', 'Götze'], [ 'Santana' /*, 'Bajner', 'Sahin' */ ]);
